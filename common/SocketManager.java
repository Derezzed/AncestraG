...
public class SocketManager {
    ...
    {
        String packet = (new StringBuilder("K")).append(str).toString();
        send(perso, packet);
        if(Ancestra.CONFIG_DEBUG)
            GameServer.addToSockLog((new StringBuilder("Game: Send>>")).append(packet).toString());
    }

    public static void GAME_SEND_hOUSE(Personnage perso, String str)
    {
        String packet = (new StringBuilder("h")).append(str).toString();
        send(perso, packet);
        if(Ancestra.CONFIG_DEBUG)
            GameServer.addToSockLog((new StringBuilder("Game: Send>>")).append(packet).toString());
    }
